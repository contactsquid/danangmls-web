...
const KO: Guide = {
  ...
  priceTitle: '월세 시세',
  priceHead: ['주택 유형', '월세 (USD)'],
  priceRows: [
    ['풀옵션 스튜디오', '$250 – $450'],
    ['침실 1개 아파트', '$350 – $600'],
    ['침실 2–3개 주택', '$500 – $1,200'],
    ['해변가 아파트', '$700 – $1,500'],
    ['수영장 딸린 빌라', '$1,500 – $4,000+'],
  ],
  priceNote: '지역, 건물, 시즌에 따라 가격대가 달라집니다. 전기·수도 요금은 보통 기본 월세와 별도로 청구됩니다.',
  stepsTitle: '임대 절차',
  steps: [
...
const RU: Guide = {
  ...
  priceHead: ['Тип жилья', 'Аренда в месяц (USD)'],
  priceRows: [
    ['Студия с мебелью', '$250 – $450'],
    ['Квартира с 1 спальней', '$350 – $600'],
    ['Дом с 2–3 спальнями', '$500 – $1,200'],
    ['Квартира у моря', '$700 – $1,500'],
    ['Вилла с бассейном', '$1,500 – $4,000+'],
  ],
  priceNote: 'Цены зависят от района, дома и сезона. Электричество и вода обычно оплачиваются сверх базовой аренды.',
