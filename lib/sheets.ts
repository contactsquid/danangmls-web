  ...
  return rows
    ...
    .map(r => {
      ...
      const listing: Listing = {
        ...
        type:         col(r, R.TYPE),
        agent:        col(r, R.AGENT),
        images:       [col(r, R.IMG1), col(r, R.IMG2), col(r, R.IMG3), col(r, R.IMG4), col(r, R.IMG5), col(r, R.IMG6), col(r, R.IMG7), col(r, R.IMG8), col(r, R.IMG9), col(r, R.IMG10)].filter(Boolean),
