...
export const translations: Record<Lang, Translations> = {
  en: {
    ...
    rentIntro: [
      ...
      `You'll find **furnished houses and apartments** for **rent** in every district — from Hai Chau and Son Tra to Ngu Hanh Son and beyond — with **monthly** and **long-term rentals** that range from *cheap* studios to high-end beachfront **houses** and **villas**. Many offer two- and three-**bedroom** layouts suited to families, couples, and remote workers, and new **rental** listings are added daily from local **real estate** agents and **property** managers.`,
    ],
